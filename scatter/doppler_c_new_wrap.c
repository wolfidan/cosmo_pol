...
/*-----------------------------------------------
              @(target):= _doppler_c_new.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__doppler_c_new

#else
#  define SWIG_init    init_doppler_c_new

#endif
#define SWIG_name    "_doppler_c_new"
...
SWIGINTERN PyObject *_wrap_get_refl(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOOOOO:get_refl",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5,&obj6,&obj7)) SWIG_fail;
  {
    npy_intp dims[1];
    if (!PyInt_Check(obj0))
    {
  ...
  }
  {
    ...
    array20 = obj_to_array_contiguous_allow_conversion(obj7,
      NPY_FLOAT,
      &is_new_object20);
  ...
  result = (float *)get_refl(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,arg14,arg15,arg16,arg17,arg18,arg19,arg20,arg21);
